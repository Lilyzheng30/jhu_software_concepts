...
@pytest.mark.db
# Test: test_split_fallback_and_normalize()
...
@pytest.mark.db
# Test: test_build_program_text_and_fallback()
...
@pytest.mark.db
# Test: test_call_llm_parses_json(monkeypatch)
...
@pytest.mark.db
# Test: test_call_llm_fallback_path(monkeypatch)
...
@pytest.mark.db
# Test: test_standardize_endpoint(monkeypatch)
...
@pytest.mark.db
# Test: test_read_lines_and_post_normalize_paths(tmp_path, monkeypatch)
...
@pytest.mark.db
# Test: test_post_normalize_university_canon_direct(monkeypatch)
...
@pytest.mark.db
# Test: test_main_serve_branch_safe(monkeypatch)
...
@pytest.mark.db
# Test: test_main_cli_branch_safe(monkeypatch, tmp_path)
